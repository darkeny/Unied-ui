...
const mockStudents = [
  { id: '1', name: 'Ana Pereira', status: 'present' },
  { id: '2', name: 'João Silva', status: 'present' },
  { id: '3', name: 'Miguel Santos', status: 'absent' },
  { id: '4', name: 'Carla Dias', status: 'present' },
  { id: '5', name: 'Hugo Mendes', status: 'present' },
];
...
const Attendance: React.FC = () => {
  ...
  return (
    <div className="animate-fadeIn">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Registo de Presenças</h1>
        <p className="text-slate-500 dark:text-slate-400">Controlo de assiduidade diário.</p>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <div className="flex-1 min-w-[150px]">
              <label className="block text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase mb-1 tracking-widest">Turma</label>
              <select 
                value={selectedClass} 
            ...
            <div className="flex-1 min-w-[150px]">
              <label className="block text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase mb-1 tracking-widest">Data</label>
              <input 
                type="date" 
                className="w-full border-none p-2.5 rounded-xl text-sm font-bold bg-slate-50 dark:bg-slate-800 dark:text-white outline-none focus:ring-2 focus:ring-indigo-500 transition-colors" 
          ...
          <div className="flex items-center gap-6 w-full md:w-auto justify-center md:justify-end border-t md:border-t-0 pt-4 md:pt-0 border-slate-100 dark:border-slate-800">
            <div className="text-center">
              <p className="text-[10px] text-slate-400 dark:text-slate-500 font-black uppercase tracking-widest">Presentes</p>
            ...
            <div className="text-center border-l border-slate-100 dark:border-slate-800 pl-6">
              <p className="text-[10px] text-slate-400 dark:text-slate-500 font-black uppercase tracking-widest">Faltas</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left min-w-[500px]">
            <thead className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 transition-colors">
              <tr>
                <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest whitespace-nowrap">Aluno</th>
                <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center whitespace-nowrap">Presença</th>
                <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center whitespace-nowrap">Falta</th>
                <th className="px-6 py-5 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest text-right whitespace-nowrap">Observações</th>
              </tr>
            </thead>
              ...
              {students.map((student) => (
                <tr key={student.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                  <td className="px-6 py-4 flex items-center gap-3">
                    ...
                    <span className="font-bold text-slate-800 dark:text-slate-200 whitespace-nowrap">{student.name}</span>
                  </td>
